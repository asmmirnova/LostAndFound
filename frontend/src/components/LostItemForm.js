          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                rows="4"
                placeholder="Подробно опишите вещь, которую вы потеряли"
              ></textarea>
            ...
            <div className="form-group">
              <label htmlFor="date_event">Дата потери*</label>
              <input
                type="date"
                id="date_event"
                name="date_event"
            ...
            <div className="form-group">
              <label htmlFor="location_event">Место потери*</label>
              <input
                type="text"
                id="location_event"
                name="location_event"
            ...
            <div className="form-group">
              ...
              <input
                ...
                className="form-control"
              />
              <small className="form-text text-muted">Загрузите фотографии потерянной вещи</small>
            </div>
